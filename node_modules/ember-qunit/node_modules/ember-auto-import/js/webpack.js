...
class WebpackBundler {
    constructor(bundles, environment, extraWebpackConfig, consoleWrite, publicAssetURL, skipBabel, babelTargets, tempArea, appRoot) {
    ...
    babelRule() {
        let shouldTranspile = shared_internals_1.babelFilter(this.skipBabel, this.appRoot);
