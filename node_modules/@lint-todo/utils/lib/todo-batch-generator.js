    ...
    generate(maybeTodos, existingTodos) {
        ...
        for (const unmatchedTodoData of maybeTodos) {
            ...
            if (matcher) {
                ...
                if (todoDatum) {
                    if ((0, date_utils_1.isExpired)(todoDatum.errorDate) && ((_b = (_a = this.options) === null || _a === void 0 ? void 0 : _a.shouldRemove) === null || _b === void 0 ? void 0 : _b.call(_a, todoDatum))) {
        ...
        for (const unmatchedTodoData of maybeTodos) {
            ...
            if (matcher) {
                ...
                if (todoDatum) {
                    if ((0, date_utils_1.isExpired)(todoDatum.errorDate) && ((_d = (_c = this.options) === null || _c === void 0 ? void 0 : _c.shouldRemove) === null || _d === void 0 ? void 0 : _d.call(_c, todoDatum))) {
                        expired.add(todoDatum);
                    }
                    else {
                        copyLintResult(todoDatum, unmatchedTodoData);
