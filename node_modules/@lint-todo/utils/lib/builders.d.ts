...
export declare function buildFromTodoOperations(todoOperations: string[], engine: Engine): Map<FilePath, TodoMatcher>;
export declare function buildTodoOperations(add: Set<TodoData>, remove: Set<TodoData>): Operation[];
export declare function toTodoDatum(todoOperation: string): [OperationType, TodoData];
