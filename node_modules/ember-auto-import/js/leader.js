...
class LeaderChooser {
    ...
    register(addon, create) {
        ...
        if (!semver_1.satisfies(addon.pkg.version, '>=2.0.0-alpha.0', {
    ...
    get leader() {
        if (!this.locked) {
            ...
            let eligible = [this.appCandidate, ...this.addonCandidates].filter((c) => semver_1.satisfies(c.version, this.appCandidate.range, {
                includePrerelease: true,
            }));
