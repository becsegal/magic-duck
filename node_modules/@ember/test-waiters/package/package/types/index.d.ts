 ...
 * @type Token
 */
export declare type Token = Primitive | unknown;
/**
 * @type Primitive
 *
 * Any of the primitive value types
 */
export declare type Primitive = string | number | boolean | symbol | bigint;
/**
 * @public
 * @interface Waiter
 */
...
export declare type PromiseType<T> = Promise<T> | RSVP.Promise<T>;
